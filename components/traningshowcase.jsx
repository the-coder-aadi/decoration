...
const TrainingShowcase = () => {
  return (
    <section className="relative overflow-hidden py-10 md:py-16 px-5 md:px-8 bg-brand-cream">
      {/* Background Glow */}
      <div className="absolute -top-40 -right-40 w-[380px] h-[380px] rounded-full bg-brand-gold/10 blur-[120px]" />
      <div className="absolute -bottom-40 -left-40 w-[380px] h-[380px] rounded-full bg-brand-primary/10 blur-[120px]" />
      ...
      <div className="relative max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
        ...
        <Reveal>
          <div>
            ...
            <div className="inline-flex items-center gap-2 rounded-full bg-brand-champagne border border-brand-primary/10 px-4 py-2 mb-6">
              <GraduationCap
                size={18}
                className="text-brand-primary"
              />
              <span className="text-xs tracking-[0.2em] uppercase text-brand-primary font-medium">
                Professional Training
              </span>
            </div>

            <h2 className="nfd-display text-4xl md:text-5xl lg:text-6xl leading-tight text-brand-ink">
              Learn The Art of
              <br />
            ...
            <p className="mt-6 text-brand-ink/70 leading-8 max-w-xl">
        ...
        <Reveal delay={150}>
          <div className="relative">
            ...
            <div className="absolute -inset-4 rounded-[40px] bg-brand-gold/10 blur-2xl" />
